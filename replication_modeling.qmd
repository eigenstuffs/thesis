...
permutation_coefficients <- data.frame(CarbonIntensity = rep(NA, 1000),
...
ggplot() + 
  ...
  labs(x = "Effect Size", y = "Count",
       ...
       subtitle = paste("p =", p_value)) + science_theme
...
ggplot(data = unpivoted_data) + 
  ...
  labs(x = "EI Score", y = "EI",
       title = "EI Score vs. EI")

ggplot(data = unpivoted_data) + 
  geom_line(aes(x = AvgCI_Score, y = AvgCI)) +
  labs(x = "CI Score", y = "CI",
       title = "CI Score vs. CI")
...
ggarrange(ggarrange(hist1, hist2, legend = FALSE, ncol = 2),
          ggarrange(hist3, legend = FALSE, ncol = 1),
          ggarrange(hist4, hist5, legend = FALSE, ncol = 2), nrow = 3, common.legend = TRUE)
```
