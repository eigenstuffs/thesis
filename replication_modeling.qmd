...
Stringency Index v2 - All Policies
...
ggplot() + geom_histogram(aes(x = permuted_stats, fill = "lightgreen")) + geom_vline(aes(xintercept = baseline_all_R2))
...
ggplot() + geom_histogram(aes(x = permuted_stats, fill = "pink")) + geom_vline(aes(xintercept = baseline_CI_R2))
...
ggplot() + geom_histogram(aes(x = permuted_stats, fill = "lightblue")) + geom_vline(aes(xintercept = baseline_EE_R2))
