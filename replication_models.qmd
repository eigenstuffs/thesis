...
xtable(
  bptest(lm(log(EmissionsPerCapita) ~ Ideology + factor(State) + factor(Year), data = panel)),
  caption = "Breusch-Pagan Test"
)

xtable(
  bptest(lm(log(CarbonIntensity) ~ Ideology + factor(State) + factor(Year), data = panel)),
  caption = "Breusch-Pagan Test"
)

xtable(
  bptest(lm(log(EnergyIntensity) ~ Ideology + factor(State) + factor(Year), data = panel)),
  caption = "Breusch-Pagan Test"
)
...
xtable(bptest(lm(EE_Score ~ Ideology + factor(State) + factor(Year), data = panel)))
...
wald_tests <- data.frame(rbind(wald(m1, print = FALSE),
                     wald(m1_no_outliers, print = FALSE),
                     wald(m2, print = FALSE),
                     wald(m2_no_outliers, print = FALSE),
...
wald_tests <- data.frame(rbind(wald(m1, print = FALSE, vcov = "iid"),
