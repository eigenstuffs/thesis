...
fit_and_cluster <- function(formula, use_data) {
  model <- glm.nb(formula = formula, data = use_data)
  print("modeled")
...
```{r}
continuous_ideology_results <- list(
  permutation = permutation_results,
  permutations = permutation_coefficients,
  coefficients = final_coefficients
)

saveRDS(continuous_ideology_results, "exports/continuous.Rds")
```
